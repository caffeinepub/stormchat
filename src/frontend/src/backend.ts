...
export class Backend implements backendInterface {
    ...
    async getUserStatuses(arg0: Array<Principal>): Promise<Array<[Principal, UserStatus]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserStatuses(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async verifySecret(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.verifySecret(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
